...
void main() {
  ...
  late AdvicerUsecases mockAdvicerUsecases;
  ...
  group('AdvicerRequestedEvent', () { 
    ...
    test('should emit loading then the error state after event is added -> usecase fails -> server failure', () async {
      // arrange
    ...
    test('should emit loading then the error state after event is added -> usecase fails -> general failure', () async {
      // arrange
